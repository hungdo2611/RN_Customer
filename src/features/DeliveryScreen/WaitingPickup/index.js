...
class WaitingPickup extends React.Component {
    ...
    onFinishBooking = async () => {
        ...
        Alert.alert(
            'Đơn hàng đã giao',
            'Đơn hàng của bạn đã được giao rồi chứ?',
            [
                {
                    text: 'Huỷ',
    ...
    renderStage = () => {
        return <View style={{ alignItems: 'center', justifyContent: "center", marginHorizontal: scale(20), marginVertical: scale(4) }}>
            <Text style={{ fontWeight: "500", fontSize: scale(18), marginVertical: scale(4) }} >Chờ tài xế</Text>
                ...
                <View style={{ flex: 1, backgroundColor: "#FFFFFF", borderRadius: scale(20) }}>
                    ...
                    <KeyboardAwareScrollView
                        ...
                        <TouchableOpacity
                            ...
                            style={{ width: scale(150), height: scale(40), alignItems: 'center', justifyContent: 'center', backgroundColor: color.GREEN_COLOR_400, borderRadius: scale(15), alignSelf: "center", marginVertical: scale(20) }}>
