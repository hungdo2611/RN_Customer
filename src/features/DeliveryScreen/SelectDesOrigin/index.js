            ...
            <View>
                ...
                <View style={{ marginVertical: scale(15), flexDirection: "row", alignItems: 'center' }}>
                    ...
                    <View style={{ flex: 1, marginLeft: scale(10) }}>
                        <Text style={{ fontSize: scale(13), fontWeight: '600' }}>Gửi hàng theo xe!</Text>
                        <Text style={{ fontSize: scale(12), fontWeight: '500', marginTop: scale(5) }}>Gửi hàng nhanh theo chuyến đi của nhà xe. Minh bạch thông tin và giá</Text>
                    </View>
                </View>
            </View>
        )
