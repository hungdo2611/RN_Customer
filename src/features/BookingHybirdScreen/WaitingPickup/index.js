...
class WaitingPickup extends React.Component {
    ...
    renderPrice = () => {
        ...
        return <View style={{ flexDirection: 'row', justifyContent: "space-between", marginHorizontal: scale(10), marginVertical: scale(10), alignItems: "center" }}>
            ...
            <Text style={{ fontSize: scale(14), fontWeight: '600' }}>{new Intl.NumberFormat().format(price)} đ</Text>
        </View>
    }
    renderSeat = () => {
        const { seat } = this.props?.currentBooking;
    ...
    renderInfoDriver = () => {
        ...
        return <View style={{ marginHorizontal: scale(10), marginBottom: scale(5) }}>
            <Text style={{ fontSize: scale(15), fontWeight: 'bold', color: color.GRAY_COLOR_500, marginVertical: scale(5) }}>Thông tin nhà xe</Text>
